...
class FavforecastPage extends StatefulWidget {
  static final String id = 'TestFavforecastPage';
  final fav;

  const FavforecastPage({Key? key, this.fav}) : super(key: key);

  @override
  _FavforecastPageState createState() => _FavforecastPageState();
}

class _FavforecastPageState extends State<FavforecastPage> {
  ...
  void initState() {
    super.initState();
    print(widget.fav);
    _getWeatherData(widget.fav);
    _cityName = widget.fav;
  ...
  Widget build(BuildContext context) {
    ...
    if (_flag == false) {
      ...
      return Scaffold(
        appBar: AppBar(title: Text(widget.fav)),
        backgroundColor: Colors.white,
        body: Container(
            width: size.width,
            height: size.height,
